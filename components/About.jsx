...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col items-center relative justify-center">
      ...
      {/* Content Wrapper */}
      <div className="relative z-10 w-full max-w-6xl px-6 sm:px-12 mt-40 flex flex-col gap-6">
        ...
        <p className="text-white lg:text-[25px] sm:text-xl leading-relaxed font-mono">
          ...
          <br /><br/>
          We develop and maintain open-source software projects with a focus on empowering both users and developers.
          Our mission is to create tools that are not only innovative but also free, transparent, and welcoming to all.
        </p>
      </div>
    </div>
  );
