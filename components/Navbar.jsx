    ...
    <div
      className={`flex items-center justify-between px-4 md:px-15 py-2 fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scrolled && !mobileMenuOpen
          ...
          : mobileMenuOpen
          ? "bg-white/9 backdrop-blur-xs"
          : "bg-transparent border-transparent"
      }`}
    >
      <a href="#home">
        <Image src={logo} alt="FOSSMEC Logo" className="h-[95px]" />
      </a>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white/3 backdrop-blur-xs md:hidden px-4 py-5 flex flex-col gap-5 font-martian-mono">
          <a
            href="#home"
            className="text-[14px] hover:text-white/80 transition-colors"
          >
