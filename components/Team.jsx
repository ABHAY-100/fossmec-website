...
const Team = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-6 gap-8 lg:w-[90%] md:w-[80%] md:grid-cols-4 sm:grid-cols-4 min-[500px]:grid-cols-3 grid-cols-2 mb-20 px-4 justify-items-center">
